...
node generate-3d-print.js --file ./media/3d/chess-knight.stl --service all

# Step 3: Get Sculpteo pricing for a specific material
node generate-3d-print.js --file ./media/3d/chess-knight.stl --service sculpteo --material white_plastic
...
node generate-3d-print.js --file ./media/3d/chess-knight.stl --service craftcloud
```
