...
node scripts/generate-emoji.js "happy cat waving"
node scripts/generate-emoji.js "cat crying tears of joy"
node scripts/generate-emoji.js "cat with heart eyes"
node scripts/generate-emoji.js "angry cat with steam"

# Use seed for consistent character appearance
node scripts/generate-emoji.js "happy orange tabby cat waving" --seed 42
node scripts/generate-emoji.js "sad orange tabby cat crying" --seed 42
node scripts/generate-emoji.js "excited orange tabby cat celebrating" --seed 42
```
...
node scripts/generate-emoji.js "smiling robot" --model platmoji
node scripts/generate-emoji.js "robot thinking" --model platmoji
node scripts/generate-emoji.js "robot celebrating" --model platmoji

# Custom artistic style — FluxICO (supports LoRA fine-tuning)
node scripts/generate-emoji.js "kawaii pizza slice smiling" --model fluxico
node scripts/generate-emoji.js "kawaii pizza slice crying" --model fluxico --lora "https://example.com/kawaii-lora.safetensors"
```
...
node scripts/generate-emoji.js "convert to happy emoji style" --model kontextemoji --image ./input/my-photo.png

# Turn a product into an emoji
node scripts/generate-emoji.js "make this a cute cartoon emoji" --model kontextemoji --image ./input/product.png
```
...
node scripts/generate-emoji.js "$CHAR smiling happily" --seed 100 --width 512 --height 512
node scripts/generate-emoji.js "$CHAR laughing with tears" --seed 100 --width 512 --height 512
node scripts/generate-emoji.js "$CHAR crying sadly" --seed 100 --width 512 --height 512
node scripts/generate-emoji.js "$CHAR angry with red face" --seed 100 --width 512 --height 512
node scripts/generate-emoji.js "$CHAR surprised with wide eyes" --seed 100 --width 512 --height 512
node scripts/generate-emoji.js "$CHAR thinking with hand on chin" --seed 100 --width 512 --height 512
node scripts/generate-emoji.js "$CHAR sleeping with zzz" --seed 100 --width 512 --height 512
node scripts/generate-emoji.js "$CHAR waving hello" --seed 100 --width 512 --height 512
node scripts/generate-emoji.js "$CHAR giving thumbs up" --seed 100 --width 512 --height 512
node scripts/generate-emoji.js "$CHAR heart eyes in love" --seed 100 --width 512 --height 512
node scripts/generate-emoji.js "$CHAR facepalm" --seed 100 --width 512 --height 512
node scripts/generate-emoji.js "$CHAR party horn celebrating" --seed 100 --width 512 --height 512
```
...
node scripts/generate-edit-image.js --model rembg --image ./media/images/*emoji*.png

# Process all emojis in batch (PowerShell)
Get-ChildItem ./media/images/*emoji*.png | ForEach-Object {
    node scripts/generate-edit-image.js --model rembg --image $_.FullName
}
```
...
node scripts/generate-edit-image.js "clean up the edges, make the outline crisp" --model kontext --image ./media/images/*rembg*.png

# Upscale if needed for high-DPI displays
node scripts/generate-edit-image.js --model upscale --image ./media/images/*rembg*.png --scale 2
```
...
node scripts/generate-edit-image.js --model upscale --image ./media/images/*sdxlemoji*.png

# Ensure background is removed
node scripts/generate-edit-image.js --model rembg --image ./media/images/*upscale*.png
```
...
node scripts/generate-sticker-print.js --file ./media/images/*rembg*.png --service all

# Upload to Printify via API and browse sticker catalog
node scripts/generate-sticker-print.js --file ./media/images/*rembg*.png --service printify

# Order die-cut stickers from StickerMule (opens browser)
node scripts/generate-sticker-print.js --file ./media/images/*rembg*.png --service stickermule --type die-cut

# List available sticker products
node scripts/generate-sticker-print.js --list --service printify
```
...
node scripts/generate-emoji.js "$CHAR smiling happily, white background" --seed 42 --width 512 --height 512
node scripts/generate-emoji.js "$CHAR laughing hard, white background" --seed 42 --width 512 --height 512
node scripts/generate-emoji.js "$CHAR crying sadly, white background" --seed 42 --width 512 --height 512
node scripts/generate-emoji.js "$CHAR very angry, white background" --seed 42 --width 512 --height 512
node scripts/generate-emoji.js "$CHAR shocked surprised, white background" --seed 42 --width 512 --height 512
node scripts/generate-emoji.js "$CHAR thinking deeply, white background" --seed 42 --width 512 --height 512
node scripts/generate-emoji.js "$CHAR sleeping peacefully, white background" --seed 42 --width 512 --height 512
node scripts/generate-emoji.js "$CHAR waving hello, white background" --seed 42 --width 512 --height 512
node scripts/generate-emoji.js "$CHAR thumbs up, white background" --seed 42 --width 512 --height 512
node scripts/generate-emoji.js "$CHAR heart eyes love, white background" --seed 42 --width 512 --height 512
node scripts/generate-emoji.js "$CHAR facepalm, white background" --seed 42 --width 512 --height 512
node scripts/generate-emoji.js "$CHAR party horn celebrating, white background" --seed 42 --width 512 --height 512
...
node scripts/generate-emoji.js "happy fox waving" --model platmoji --width 512 --height 512
node scripts/generate-emoji.js "fox giving thumbs up" --model platmoji --width 512 --height 512
node scripts/generate-emoji.js "fox crying" --model platmoji --width 512 --height 512
node scripts/generate-emoji.js "fox laughing" --model platmoji --width 512 --height 512
node scripts/generate-emoji.js "fox angry" --model platmoji --width 512 --height 512
node scripts/generate-emoji.js "fox heart eyes" --model platmoji --width 512 --height 512
...
node scripts/generate-emoji.js "make this a smiling emoji, white background" --model kontextemoji --image ./brand/mascot.png
node scripts/generate-emoji.js "make this a thumbs up emoji, white background" --model kontextemoji --image ./brand/mascot.png
node scripts/generate-emoji.js "make this a thinking emoji, white background" --model kontextemoji --image ./brand/mascot.png
...
*See also: [generate-emoji.md](../scripts/generate-emoji.md) · [generate-edit-image.md](../scripts/generate-edit-image.md) · [generate-sticker-print.md](../scripts/generate-sticker-print.md)*
