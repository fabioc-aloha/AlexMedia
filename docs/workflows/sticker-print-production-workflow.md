...
node scripts/generate-emoji.js "happy robot with thumbs up, bold outline, white background" --model sdxlemoji --width 512 --height 512

# Cute animal sticker
node scripts/generate-emoji.js "smiling shiba inu, sticker style, thick black outline, white background" --model platmoji

# Custom character from a photo (photo-to-emoji)
node scripts/generate-emoji.js "make this a cute cartoon emoji sticker, white background" --model kontextemoji --image ./photo.jpg
```
...
node scripts/generate-image.js "minimalist coffee cup sticker design, flat illustration, white background, vector style" --model flux2pro

# Character sticker sheet design
node scripts/generate-image.js "cute space explorer character in 6 poses: waving, jumping, sleeping, eating, reading, running — sticker sheet layout, white background" --model nanapro

# Logo adaptation
node scripts/generate-image.js "convert this logo into a sticker design with bold outline and drop shadow" --model kontext --image ./logo.png
```
...
node scripts/generate-edit-image.js --model rembg --image ./media/images/*sdxlemoji*.png

# Clean up edges after removal
node scripts/generate-edit-image.js "clean up rough edges, smooth the outline" --model kontext --image ./media/images/*rembg*.png
```
...
node scripts/generate-edit-image.js --model upscale --image ./media/images/*rembg*.png

# 2× upscale for large prints
node scripts/generate-edit-image.js --model upscale --image ./design.png --scale 2
```
...
node scripts/generate-sticker-print.js --file ./print-ready.png --service printify

# List all available sticker products
node scripts/generate-sticker-print.js --list --service printify
node scripts/generate-sticker-print.js --list --service printful

# Upload to Printful
node scripts/generate-sticker-print.js --file ./print-ready.png --service printful
```
...
node scripts/generate-sticker-print.js --file ./print-ready.png --service all

# Open specific service with sticker type pre-selected
node scripts/generate-sticker-print.js --file ./print-ready.png --service stickermule --type die-cut
node scripts/generate-sticker-print.js --file ./print-ready.png --service stickerapp --type kiss-cut
node scripts/generate-sticker-print.js --file ./print-ready.png --service stickergiant --type vinyl
node scripts/generate-sticker-print.js --file ./print-ready.png --service redbubble

# Open with additional options
node scripts/generate-sticker-print.js --file ./print-ready.png --service stickermule --type holographic --quantity 50 --size 3x3
```
...
| Halo/white fringe | Tighten `rembg` mask: `node scripts/generate-edit-image.js "clean up edges" --model kontext` |
...
node scripts/generate-emoji.js "$CHAR happy, white background" --seed 7 --model sdxlemoji --width 512 --height 512
node scripts/generate-emoji.js "$CHAR sad, white background" --seed 7 --model sdxlemoji --width 512 --height 512
node scripts/generate-emoji.js "$CHAR surprised, white background" --seed 7 --model sdxlemoji --width 512 --height 512
node scripts/generate-emoji.js "$CHAR laughing, white background" --seed 7 --model sdxlemoji --width 512 --height 512
...
Get-ChildItem ./media/images/*rembg*.png | ForEach-Object {
    node scripts/generate-edit-image.js --model upscale --image $_.FullName
}

# 4. Order die-cut stickers from StickerMule
node scripts/generate-sticker-print.js --file ./media/images/*upscale*happy*.png --service stickermule --type die-cut --size 3x3 --quantity 50
```
...
node scripts/generate-image.js "minimalist geometric mountain logo, flat vector, white background, bold shapes" --model flux2pro --width 1024 --height 1024

# 2. Remove background
node scripts/generate-edit-image.js --model rembg --image ./media/images/*flux2pro*.png

# 3. Upscale for 4" × 4" print (at 300 DPI needs 1200px)
node scripts/generate-edit-image.js --model upscale --image ./media/images/*rembg*.png

# 4. Order vinyl stickers
node scripts/generate-sticker-print.js --file ./media/images/*upscale*.png --service stickerapp --type vinyl --size 4x4 --quantity 100
```
...
node scripts/generate-image.js "anime-style dragon character, vibrant neon colors, black background, glowing effect" --model nanapro --width 512 --height 512
...
node scripts/generate-sticker-print.js --file ./media/images/*upscale*.png --service stickermule --type holographic --size 3x3 --quantity 50
```
...
do
    node scripts/generate-emoji.js "$theme - $emotion, white background" --model sdxlemoji
done
...
# 4. Order the sheet
node scripts/generate-sticker-print.js --file ./media/images/*rembg*rocket*.png --service stickerapp --type sheet
```
...
node scripts/generate-sticker-print.js --file ./sticker.png --service printify
...
*See also: [generate-sticker-print.md](../scripts/generate-sticker-print.md) · [emoji-sticker-workflow.md](emoji-sticker-workflow.md) · [generate-emoji.md](../scripts/generate-emoji.md) · [generate-edit-image.md](../scripts/generate-edit-image.md)*
