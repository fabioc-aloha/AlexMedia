...
```bash
# Quick concept art
node scripts/generate-image.js "a small desk lamp shaped like a mushroom, clean white background, product photo" --model imagen4

# Multiple angles for complex objects
node scripts/generate-image.js "miniature fantasy castle, front view, white background, studio lighting" --model nanapro
node scripts/generate-image.js "miniature fantasy castle, side view, white background, studio lighting" --model nanapro
node scripts/generate-image.js "miniature fantasy castle, back view, white background, studio lighting" --model nanapro
```
...
node scripts/generate-edit-image.js --model rembg --image ./concept.jpg

# Upscale a low-res reference
node scripts/generate-edit-image.js --model upscale --image ./concept.jpg --scale 4

# Modify details
node scripts/generate-edit-image.js "remove the handle, make the base wider" --model kontext --image ./lamp.jpg
```
...
| ------ | ------------------- | --------- |
| Best all-around quality | `trellis` | `node scripts/generate-3d.js --model trellis --image ./ref.png --stl` |
| Highest detail, PBR materials | `rodin` | `node scripts/generate-3d.js --model rodin --image ./ref.png --stl --quality high` |
| Multi-view precision | `hunyuan2mv` | `node scripts/generate-3d.js --model hunyuan2mv --front ./f.png --back ./b.png --stl` |
| Text-only (no reference image) | `trellis` or `rodin` | `node scripts/generate-3d.js "a gear wheel" --model rodin --stl` |
| Fast prototype / draft | `shape` | `node scripts/generate-3d.js "a chair" --model shape` |
| High-poly organic forms | `hunyuan` | `node scripts/generate-3d.js --model hunyuan --image ./sculpture.png --stl --faces 40000` |
...
node scripts/generate-3d.js --model trellis --image ./mushroom-lamp.png --stl

# From text — Rodin with native STL and high quality
node scripts/generate-3d.js "a chess rook piece" --model rodin --stl --quality high --meshmode Triangle

# From multi-view images — Hunyuan2mv
node scripts/generate-3d.js --model hunyuan2mv --front ./front.png --back ./back.png --left ./left.png --right ./right.png --stl
```
...
Output lands in `./media/3d/` as both the 3D file and a JSON report with generation metadata.
...
node scripts/generate-3d-print.js --file ./media/3d/model.stl --service all

# Compare pricing on Craftcloud (aggregates 150+ manufacturers)
node scripts/generate-3d-print.js --file ./media/3d/model.stl --service craftcloud

# Get specific material pricing from Sculpteo (no account needed)
node scripts/generate-3d-print.js --file ./media/3d/model.stl --service sculpteo --material nylon

# Budget-friendly printing via PCBWay
node scripts/generate-3d-print.js --file ./media/3d/model.stl --service pcbway
```
...
node scripts/generate-image.js "geometric desk organizer, white background" --model imagen4
node scripts/generate-edit-image.js --model rembg --image ./media/images/*imagen*.png
node scripts/generate-3d.js --model trellis --image ./media/images/*rembg*.png --stl
node scripts/generate-3d-print.js --file ./media/3d/*trellis*.stl --service all
```
...
node scripts/generate-image.js "a cute wizard figurine holding a staff, white background, product photo" --model nanapro

# 2. Clean up the reference
node scripts/generate-edit-image.js --model rembg --image ./media/images/*nanapro*.png
...
node scripts/generate-3d.js "an involute spur gear with 24 teeth" --model rodin --stl --quality extra-high --meshmode Triangle

# 2. Inspect in Meshmixer → repair if needed → confirm dimensions

# 3. Get production quotes
node scripts/generate-3d-print.js --file ./media/3d/*rodin*.stl --service sculpteo --material nylon
node scripts/generate-3d-print.js --file ./media/3d/*rodin*.stl --service xometry
...
node scripts/generate-image.js "elegant silver ring with Celtic knot pattern, product photo, white background" --model ideoqual
node scripts/generate-image.js "same ring from side view" --model ideoqual

# 2. Generate high-detail 3D model
node scripts/generate-3d.js --model rodin --image ./media/images/*ideoqual*.png --stl --quality extra-high --faces 60000

# 3. Upload to Shapeways for precious metal casting
node scripts/generate-3d-print.js --file ./media/3d/*rodin*.stl --service shapeways --material silver
...
node scripts/generate-image.js "detailed dragon sculpture, T-pose, white background" --model nanapro

# 2. Generate 3D model
node scripts/generate-3d.js --model rodin --image ./media/images/*nanapro*.png --stl --quality high --tpose
...
node -e "
const fs=require('fs'),src='./media/3d/model.stl',dst='./media/3d/model-print-ready.stl';
...
GENERATE REFERENCE IMAGE
  node scripts/generate-image.js "<description>, white background" --model imagen4

REMOVE BACKGROUND
  node scripts/generate-edit-image.js --model rembg --image ./media/images/<file>.png

GENERATE 3D MODEL (with STL for printing)
  node scripts/generate-3d.js --model trellis --image ./media/images/<file>.png --stl
  node scripts/generate-3d.js --model rodin "<description>" --stl --quality high
...
PRINT ONLINE
  node scripts/generate-3d-print.js --file ./media/3d/<file>.stl --service all
```

---

*See also: [generate-3d.md](../scripts/generate-3d.md) · [generate-3d-print.md](../scripts/generate-3d-print.md) · [3d-printing-services-guide.md](3d-printing-services-guide.md)*
