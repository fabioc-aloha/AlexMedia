...
node scripts/generate-3d.js "a medieval chess knight piece" --model rodin --stl

# Step 2: Get printing quotes from all services
node scripts/generate-3d-print.js --file ./media/3d/chess-knight.stl --service all

# Step 3: Get Sculpteo pricing for a specific material
node scripts/generate-3d-print.js --file ./media/3d/chess-knight.stl --service sculpteo --material white_plastic
...
node scripts/generate-3d-print.js --file ./media/3d/chess-knight.stl --service craftcloud
```

For API service details and setup instructions, see [generate-3d-print.md](../scripts/generate-3d-print.md).
...
- [generate-3d-print.md](../scripts/generate-3d-print.md) — CLI tool reference for the print service integration script
- [generate-3d.md](../scripts/generate-3d.md) — AI 3D model generation with STL output support
