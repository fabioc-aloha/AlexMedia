...
node scripts/generate-image.js "professional headshot of a confident woman in business attire, studio lighting, neutral background"

# Google Imagen 4 — photorealistic
node scripts/generate-image.js "golden retriever puppy playing in autumn leaves, soft bokeh background" --model imagen4

# Creative illustration — SeDream
node scripts/generate-image.js "enchanted forest with bioluminescent mushrooms, fantasy illustration" --model seedream

# Text-heavy design — GPT Image
node scripts/generate-image.js "minimalist poster design reading 'LAUNCH DAY' in bold sans-serif, gradient background" --model gptimage

# Specific style — Recraft
node scripts/generate-image.js "flat vector icon of a rocket ship, gradient blue" --model recraft --style "digital_illustration"

# High resolution — Flux 2 Pro
node scripts/generate-image.js "macro photography of dewdrops on a spider web at sunrise" --model flux2pro --aspect 16:9
```
...
node scripts/generate-image.js "change the background to a tropical beach at sunset" --model gptimage --image ./input/portrait.png

# Edit with Kontext — precise prompt-based edits
node scripts/generate-edit-image.js "change her dress color to red" --model kontext --image ./media/images/fashion.png
```
...
node scripts/generate-image.js "cute cartoon animal mascots for a tech startup" --model gptimage --count 10

# 15 variations — SeDream
node scripts/generate-image.js "abstract background pattern, colorful geometric shapes" --model seedream --count 15

# Use seed for reproducible results
node scripts/generate-image.js "landscape at golden hour" --model nanapro --seed 42
```
...
node scripts/generate-edit-image.js "change the sky to a dramatic sunset" --model kontext --image ./media/images/landscape.png

# More powerful edits — Kontext Max
node scripts/generate-edit-image.js "add a crown of flowers to her head" --model kontextmax --image ./media/images/portrait.png

# Mask-based inpainting — edit only a specific region
node scripts/generate-edit-image.js "replace with a window showing a city view" --model nana --image ./media/images/room.png --mask ./masks/wall-area.png

# Fine detail painting — PEdit
node scripts/generate-edit-image.js "add realistic freckles to the face" --model pedit --image ./media/images/portrait.png
```
...
node scripts/generate-edit-image.js --model rembg --image ./media/images/product.png

# Generate new background
node scripts/generate-edit-image.js "professional studio with white cyclorama" --model bggen --image ./media/images/product.png

# Complex background replacement
node scripts/generate-edit-image.js "cozy coffee shop interior with warm lighting" --model bggen --image ./media/images/portrait.png
```
...
node scripts/generate-edit-image.js "continue the landscape naturally" --model expand --image ./media/images/square.png --outpaint "left=200,right=200"

# Extend upward — add sky
node scripts/generate-edit-image.js "dramatic cloudy sky" --model expand --image ./media/images/scene.png --outpaint "top=300"
```
...
node scripts/generate-edit-image.js --model eraser --image ./media/images/photo.png --mask ./masks/remove-this.png

# Fill an area with contextual content
node scripts/generate-edit-image.js "a potted plant on a wooden table" --model fillpro --image ./media/images/room.png --mask ./masks/fill-area.png

# Adobe Generative Fill
node scripts/generate-edit-image.js "autumn leaves scattered on ground" --model genfill --image ./media/images/path.png --mask ./masks/ground.png
```
...
node scripts/generate-edit-image.js --model upscale --image ./media/images/final.png --scale 2

# 4x upscale for print (300 DPI)
node scripts/generate-edit-image.js --model upscale --image ./media/images/final.png --scale 4
```
...
node scripts/generate-edit-image.js --model restore --image ./media/images/compressed.jpg

# Face enhancement for portraits
node scripts/generate-edit-image.js --model restore --image ./media/images/portrait.png --face-enhance
```
...
node scripts/generate-image.js "wireless headphones floating in air, white background, product photography, studio lighting" --model imagen4

# 2. Remove background for transparency
node scripts/generate-edit-image.js --model rembg --image ./media/images/*imagen4*.png

# 3. Add lifestyle background
node scripts/generate-edit-image.js "modern minimalist desk setup with warm ambient lighting" --model bggen --image ./media/images/*rembg*.png

# 4. Upscale to 1080×1080 quality
node scripts/generate-edit-image.js --model upscale --image ./media/images/*bggen*.png --scale 2
```
...
node scripts/generate-image.js "ancient temple hidden in a bioluminescent jungle, concept art, wide establishing shot" --model seedream --count 5

# 2. Pick the best, refine details
node scripts/generate-edit-image.js "add a stone bridge crossing a glowing river in the foreground" --model kontextmax --image ./media/images/best-concept.png

# 3. Extend canvas for panoramic view
node scripts/generate-edit-image.js "dense jungle continuing naturally" --model expand --image ./media/images/*kontext*.png --outpaint "left=400,right=400"

# 4. Upscale for presentation
node scripts/generate-edit-image.js --model upscale --image ./media/images/*expand*.png --scale 2
```
...
node scripts/generate-image.js "fantasy warrior elf with silver armor, front view, character concept art, white background" --model nanapro --seed 12345

# 2. Generate consistent variations using seed
node scripts/generate-image.js "fantasy warrior elf with silver armor, side profile view, character concept art, white background" --model nanapro --seed 12345
node scripts/generate-image.js "fantasy warrior elf with silver armor, back view showing cape, character concept art, white background" --model nanapro --seed 12345

# 3. Remove backgrounds for clean sheet
node scripts/generate-edit-image.js --model rembg --image ./media/images/*front*.png
node scripts/generate-edit-image.js --model rembg --image ./media/images/*side*.png
node scripts/generate-edit-image.js --model rembg --image ./media/images/*back*.png
```
...
node scripts/generate-image.js "abstract gradient background, deep purple to teal, soft bokeh lights" --model flux2max --aspect 16:9

# 2. Add text overlay (GPT Image excels at text)
node scripts/generate-image.js "add bold white text 'THE FUTURE OF AI' centered on this background" --model gptimage --image ./media/images/*flux2max*.png

# 3. Alternatively, use Ideogram for typography (ideoturbo — ideoqual fails silently)
node scripts/generate-image.js "blog banner with title 'The Future of AI' in modern sans-serif, gradient purple-teal background" --model ideoturbo --aspect 16:9
```
...
*See also: [generate-image.md](../scripts/generate-image.md) · [generate-edit-image.md](../scripts/generate-edit-image.md)*
