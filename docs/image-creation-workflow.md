...
node generate-edit-image.js "change her dress color to red" --model kontext --image ./output/fashion.png
```
...
node generate-edit-image.js "change the sky to a dramatic sunset" --model kontext --image ./output/landscape.png

# More powerful edits — Kontext Max
node generate-edit-image.js "add a crown of flowers to her head" --model kontextmax --image ./output/portrait.png

# Mask-based inpainting — edit only a specific region
node generate-edit-image.js "replace with a window showing a city view" --model nana --image ./output/room.png --mask ./masks/wall-area.png

# Fine detail painting — PEdit
node generate-edit-image.js "add realistic freckles to the face" --model pedit --image ./output/portrait.png
```
...
node generate-edit-image.js --model rembg --image ./output/product.png

# Generate new background
node generate-edit-image.js "professional studio with white cyclorama" --model bggen --image ./output/product.png

# Complex background replacement
node generate-edit-image.js "cozy coffee shop interior with warm lighting" --model bggen --image ./output/portrait.png
```
...
node generate-edit-image.js "continue the landscape naturally" --model expand --image ./output/square.png --outpaint "left=200,right=200"

# Extend upward — add sky
node generate-edit-image.js "dramatic cloudy sky" --model expand --image ./output/scene.png --outpaint "top=300"
```
...
node generate-edit-image.js --model eraser --image ./output/photo.png --mask ./masks/remove-this.png

# Fill an area with contextual content
node generate-edit-image.js "a potted plant on a wooden table" --model fillpro --image ./output/room.png --mask ./masks/fill-area.png

# Adobe Generative Fill
node generate-edit-image.js "autumn leaves scattered on ground" --model genfill --image ./output/path.png --mask ./masks/ground.png
```
...
node generate-edit-image.js --model upscale --image ./output/final.png --scale 2

# 4x upscale for print (300 DPI)
node generate-edit-image.js --model upscale --image ./output/final.png --scale 4
```
...
node generate-edit-image.js --model restore --image ./output/compressed.jpg

# Face enhancement for portraits
node generate-edit-image.js --model restore --image ./output/portrait.png --face-enhance
```
...
node generate-edit-image.js --model rembg --image ./output/*imagen4*.png

# 3. Add lifestyle background
node generate-edit-image.js "modern minimalist desk setup with warm ambient lighting" --model bggen --image ./output/*rembg*.png

# 4. Upscale to 1080×1080 quality
node generate-edit-image.js --model upscale --image ./output/*bggen*.png --scale 2
```
...
node generate-edit-image.js "add a stone bridge crossing a glowing river in the foreground" --model kontextmax --image ./output/best-concept.png

# 3. Extend canvas for panoramic view
node generate-edit-image.js "dense jungle continuing naturally" --model expand --image ./output/*kontext*.png --outpaint "left=400,right=400"

# 4. Upscale for presentation
node generate-edit-image.js --model upscale --image ./output/*expand*.png --scale 2
```
...
node generate-edit-image.js --model rembg --image ./output/*front*.png
node generate-edit-image.js --model rembg --image ./output/*side*.png
node generate-edit-image.js --model rembg --image ./output/*back*.png
```
...
node generate-image.js "add bold white text 'THE FUTURE OF AI' centered on this background" --model gptimage --image ./output/*flux2max*.png
