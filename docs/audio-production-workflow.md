...
node generate-voice.js "Welcome to our product demo. Today we'll explore three features that will transform your workflow." --model mm28hd --voice English_Male_1

# Fast iteration — MiniMax v2.8 Turbo
node generate-voice.js "Welcome to our product demo." --model mm28turbo --voice English_Female_1

# Older but stable — MiniMax v0.2 HD
node generate-voice.js "This is a professional narration for a corporate video." --model mm02hd --voice English_Male_1
```
...
```bash
# Happy tone
node generate-voice.js "We're thrilled to announce our biggest update ever!" --model mm28turbo --emotion happy --speed 1.1

# Calm, serious tone
node generate-voice.js "In a world of constant change, stability is everything." --model mm28turbo --emotion calm --speed 0.9

# Dramatic delivery — Chatterbox
node generate-voice.js "The door creaked open. Something moved in the darkness." --model chatterbox

# High-energy — Chatterbox Pro
node generate-voice.js "ARE YOU READY? The sale of the century starts NOW!" --model chatpro
```
...
node generate-voice.js "Bienvenue dans notre démonstration de produit." --model chatmlang --audio ./french-ref.mp3

# Japanese narration — Kokoro (offline-capable)
node generate-voice.js "製品デモへようこそ。" --model kokoro --language ja

# Design a voice from a text description — Qwen 3 TTS
node generate-voice.js "Welcome to our showcase." --model qwentts
# Use voice_design mode in Qwen to describe: "Young female, warm, confident, slight British accent"

# ElevenLabs — premium quality
node generate-voice.js "This is a premium narration." --model elevenv3 --voice Rachel
```
...
node generate-music.js "cinematic ambient soundtrack, hopeful, inspiring, no vocals, orchestral strings" --model stableaudio --duration 60

# Corporate / presentation background
node generate-music.js "modern corporate background music, upbeat, clean, no vocals" --model stableaudio --duration 120

# Chill lofi beats
node generate-music.js "lofi hip hop beats, relaxing, vinyl crackle, calm piano" --model music15

# Epic trailer music
node generate-music.js "epic cinematic trailer music, building tension, orchestral, drums" --model lyria2

# Short jingle (exact milliseconds)
node generate-music.js "happy corporate jingle, cheerful" --model stableaudio --lengthms 10000
```
...
```bash
# Pop song structure
node generate-music.js "upbeat indie pop" --model music15 --lyrics "[verse]
...
# Rock ballad
node generate-music.js "acoustic rock ballad, emotional, guitar" --model music15 --lyrics "[intro]
[verse]
...
node generate-music.js "energetic electronic dance music" --model music01 --songfile ./reference-song.mp3

# Use separate vocal and instrumental references
node generate-music.js "pop ballad" --model music01 --voicefile ./vocal-ref.mp3 --instrfile ./instrumental-ref.mp3
```
...
node generate-music.js "upbeat podcast intro jingle, modern, energetic, no vocals" --model stableaudio --duration 20

# 2. Generate host intro voiceover
node generate-voice.js "Welcome to The Tech Hour, your weekly deep dive into the world of technology. I'm your host, Alex." --model mm28hd --voice English_Male_1 --speed 1.05
...
node generate-voice.js "Our platform helps teams collaborate in real time." --model mm28hd --voice English_Female_1 --speed 0.95
node generate-voice.js "With built-in analytics, you can track progress at a glance." --model mm28hd --voice English_Female_1 --speed 0.95
node generate-voice.js "Try it free for 30 days. No credit card required." --model mm28hd --voice English_Female_1 --speed 0.95

# 2. Generate background music (match total duration ~45s)
node generate-music.js "light corporate ambient, inspiring, clean, no vocals" --model stableaudio --duration 45
...
node generate-music.js "dreamy indie folk, acoustic guitar, female vocals" --model music15 --lyrics "[verse]
...
node generate-music.js "dreamy indie folk, acoustic guitar, female vocals" --model music15 --lyrics "..." --seed 100
node generate-music.js "dreamy indie folk, acoustic guitar, female vocals" --model music15 --lyrics "..." --seed 200
node generate-music.js "dreamy indie folk, acoustic guitar, female vocals" --model music15 --lyrics "..." --seed 300
...
```bash
# 1. English version
node generate-voice.js "Welcome to our cutting-edge platform." --model mm28hd --voice English_Female_1

# 2. French version
node generate-voice.js "Bienvenue sur notre plateforme innovante." --model chatmlang --audio ./french-voice-ref.mp3

# 3. Japanese version
node generate-voice.js "革新的なプラットフォームへようこそ。" --model kokoro --language ja

# 4. Same background music for all
node generate-music.js "modern minimal corporate, no vocals" --model stableaudio --duration 15
```
...
*See also: [generate-voice.md](generate-voice.md) · [generate-music.md](generate-music.md) · [generate-edit-video.md](generate-edit-video.md) · [video-production-workflow.md](video-production-workflow.md)*
