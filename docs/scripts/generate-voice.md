...
node scripts/generate-voice.js "Hello, welcome to the demo!"

# Specific model + voice
node scripts/generate-voice.js "Breaking news today" --model elevenv3 --voice Rachel
node scripts/generate-voice.js "Bonjour le monde" --model chatmlang --audio ./french-sample.mp3

# Voice cloning
node scripts/generate-voice.js --model mmclone --audio ./voice-sample.mp3

# Qwen3 TTS with voice design
node scripts/generate-voice.js "Hello" --model qwentts --mode voice_design --voicedesc "young female, warm"
```
