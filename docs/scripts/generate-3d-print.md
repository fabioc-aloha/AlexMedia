...
node scripts/generate-3d-print.js --file ./model.stl --service shapeways

# Upload to Sculpteo and get pricing for plastic materials
node scripts/generate-3d-print.js --file ./model.stl --service sculpteo --material plastic

# List available materials
node scripts/generate-3d-print.js --list --service sculpteo

# Open browser-based services for manual quoting
node scripts/generate-3d-print.js --file ./model.stl --service craftcloud
```
...
node scripts/generate-3d-print.js --file ./model.stl --service shapeways --material nylon

# List all available materials
node scripts/generate-3d-print.js --list --service shapeways
```
...
node scripts/generate-3d-print.js --file ./model.stl --service sculpteo

# Get quotes in EUR for 3 copies
node scripts/generate-3d-print.js --file ./model.stl --service sculpteo --quantity 3 --currency EUR

# Filter by material type
node scripts/generate-3d-print.js --file ./model.stl --service sculpteo --material titanium
...
```bash
node scripts/generate-3d-print.js --file ./model.stl --service materialise
```

### PCBWay 3D Printing
Affordable 3D printing alongside PCB manufacturing. Supports SLA, SLS, MJF, FDM, DMLS.
```bash
node scripts/generate-3d-print.js --file ./model.stl --service pcbway
```

### Xometry
AI-powered instant quoting for 3D printing, CNC machining, sheet metal, and injection molding.
```bash
node scripts/generate-3d-print.js --file ./model.stl --service xometry
```
...
node scripts/generate-3d.js --model rodin --image ./object.png --stl
node scripts/generate-3d-print.js --file ./media/3d/*rodin*.stl --service all

# Generate and quote in one pipeline
node scripts/generate-3d.js --model trellis --image ./chair.png --stl && \
  node scripts/generate-3d-print.js --file ./media/3d/*trellis*.stl --service sculpteo
```
