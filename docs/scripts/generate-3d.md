...
```bash
# Default (Trellis)
node scripts/generate-3d.js "a medieval sword"

# From image
node scripts/generate-3d.js --model trellis --image ./sword.png

# Rodin with quality setting
node scripts/generate-3d.js "a cute robot" --model rodin --quality high --material PBR

# Hunyuan3D multi-view
node scripts/generate-3d.js --model hunyuan --image ./toy.jpg --faces 40000

# ShapeE (fast, lightweight)
node scripts/generate-3d.js "a chair" --model shape --guidance 15

# 3D Printing — native STL from Rodin
node scripts/generate-3d.js "a gear wheel" --model rodin --stl --meshmode Triangle

# 3D Printing — convert TRELLIS GLB to STL
node scripts/generate-3d.js --model trellis --image ./figurine.png --stl
```
...
- Output saved to `./media/3d/` as 3D model file + JSON report
...
node scripts/generate-3d.js "a gear wheel" --model rodin --stl --quality high --meshmode Triangle

# Hunyuan2mv — supports glb, obj, ply, stl
node scripts/generate-3d.js --model hunyuan2mv --front ./front.png --back ./back.png --stl
```
...
node scripts/generate-3d.js --model hunyuan --image ./toy.jpg --stl --faces 40000
```
