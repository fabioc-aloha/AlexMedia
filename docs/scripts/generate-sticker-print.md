...
node scripts/generate-sticker-print.js --file ./sticker.png --service all

# Upload artwork to Printify and browse sticker catalog
node scripts/generate-sticker-print.js --file ./design.png --service printify
...
node scripts/generate-sticker-print.js --file ./logo.png --service stickermule --type die-cut

# Open all browser services at once
node scripts/generate-sticker-print.js --file ./emoji.png --service all --open
```
...
node scripts/generate-sticker-print.js --file ./sticker.png --service printful
...
node scripts/generate-sticker-print.js --file ./logo.png --service stickermule

# Specific sticker type page
node scripts/generate-sticker-print.js --file ./logo.png --service stickermule --type die-cut
node scripts/generate-sticker-print.js --file ./logo.png --service stickermule --type holographic
node scripts/generate-sticker-print.js --file ./logo.png --service stickermule --type clear
```
...
```bash
node scripts/generate-sticker-print.js --file ./design.png --service stickerapp
node scripts/generate-sticker-print.js --file ./design.png --service stickerapp --type vinyl
```
...
```bash
node scripts/generate-sticker-print.js --file ./label.png --service stickergiant
node scripts/generate-sticker-print.js --file ./label.png --service stickergiant --type vinyl
```
...
```bash
node scripts/generate-sticker-print.js --file ./art.png --service redbubble
```
...
node scripts/generate-emoji.js "happy robot with wrench" --model sdxlemoji
...
node scripts/generate-sticker-print.js --file ./media/images/*rembg*.png --service all --type die-cut

# Full pipeline in one command
node scripts/generate-emoji.js "cute cat" --model sdxlemoji && \
  node scripts/generate-edit-image.js --model rembg --image ./media/images/*sdxlemoji*.png && \
