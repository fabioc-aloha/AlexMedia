...
node scripts/generate-edit-video.js "make it look cinematic" --video ./clip.mp4
...
# Merge videos
node scripts/generate-edit-video.js --model merge --video ./clip1.mp4 --extra ./clip2.mp4

# Add audio to video
node scripts/generate-edit-video.js --model avmerge --video ./clip.mp4 --audio ./track.mp3

# Extract frames
node scripts/generate-edit-video.js --model frames --video ./clip.mp4 --format png

# Upscale video
node scripts/generate-edit-video.js --model upscale --video ./clip.mp4 --resolution 4k

# Add captions
node scripts/generate-edit-video.js --model caption --video ./clip.mp4
```
